...
@login_required()
def fastmal_roi_comment(request, conn=None, **kwargs):
    """Links CommentAnnotations from ucl.ac.uk/fastmal/roi namespace to Rois

    Endpoint for /iviewer/fastmal_roi_comment/
