...
urlpatterns = patterns(
    ...
    url(r'^fastmal_roi_comment/(?P<roi_id>[0-9]+)/(?P<comments>.*?)/$', views_fastmal.fastmal_roi_comment, name='omero_iviewer_fastmal_roi_comment'),
    url(r'^fastmal_roi_comment2/$', views_fastmal.fastmal_roi_comment2, name='omero_iviewer_fastmal_roi_comment2'),
    url(r'^fastmal_image_roi_comments/(?P<image_id>[0-9]+)/$', views_fastmal.fastmal_image_roi_comments, name='omero_iviewer_fastmal_image_roi_comments'),
